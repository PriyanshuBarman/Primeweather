...
const SunriseSunset = () => {
  ...
  return (
    <div
      ref={widgetRef}
      onClick={handleClick}
      className="hover-scale-2 relative mt-7 w-[95%] cursor-pointer flex-col items-center rounded-2xl border-r border-t border-black/10 bg-white/25 pb-1 text-xs shadow-md shadow-black/20 dark:border-white/5 dark:bg-[#171717] dark:shadow-black md:mt-3 md:w-[92%] md:bg-white md:dark:mt-4 md:dark:w-[97%] md:dark:bg-[#1c1c1c]"
    >
