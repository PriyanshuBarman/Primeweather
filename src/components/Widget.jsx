...
const Widget = ({ name, data, unit, icon, isHidden, label }) => {
  ...
  return (
    <div
      ref={widgetRef}
      onClick={handleClick}
      className="widget hover-scale group relative flex h-[120px] w-[148px] cursor-pointer select-none flex-wrap justify-center rounded-2xl rounded-tl-md bg-white/25 pb-1 pr-4 pt-2 text-black/80 shadow-[3px_5px_5px_.2px] shadow-black/30 dark:bg-black/15 dark:text-white/80 dark:shadow-black md:h-[109px] md:w-[150px] md:shadow-[2px_3px_3px_.2px] md:shadow-black/15"
    >
