    ...
    <div className="flex h-auto w-full items-center justify-around px-[40%]">
      <div className="group relative">
        <a
          ...
          className="relative flex items-center justify-center rounded-full bg-white p-3 shadow-md transition-all ease-linear hover:scale-110 group-hover:bg-[#0077B5] group-hover:text-white dark:bg-white/10"
        ...
        <div className="absolute bottom-0 left-1/2 mb-4 -translate-x-1/2 scale-0 opacity-0 transition-all duration-300 ease-out group-hover:-translate-y-10 group-hover:scale-100 group-hover:opacity-100">
          <div className="relative">
            <div className="whitespace-nowrap rounded-md bg-[#0077B5] px-4 py-2 text-sm font-[500] text-white">
              LinkedIn
            </div>
            <div className="absolute bottom-[-5px] left-1/2 -translate-x-1/2 border-l-[6px] border-r-[6px] border-t-[6px] border-l-transparent border-r-transparent border-t-[#0077B5]"></div>
          </div>
        </div>
      </div>
      ...
      <div className="group relative">
        ...
        <div className="absolute bottom-0 left-1/2 mb-4 -translate-x-1/2 scale-0 opacity-0 transition-all duration-300 ease-out group-hover:-translate-y-10 group-hover:scale-100 group-hover:opacity-100">
          <div className="relative">
            <div className="whitespace-nowrap rounded-md bg-black px-4 py-2 text-sm font-[500] text-white dark:bg-white/10">
              GitHub
            </div>
            <div className="absolute bottom-[-5px] left-1/2 -translate-x-1/2 border-l-[6px] border-r-[6px] border-t-[6px] border-l-transparent border-r-transparent border-t-black dark:border-t-white/10"></div>
          </div>
        </div>
      </div>
      <div className="group relative">
      ...
      <div className="group relative">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="relative flex items-center justify-center rounded-full bg-white p-3 shadow-md transition-all ease-linear hover:scale-110 group-hover:bg-[#1DA1F2] group-hover:text-white dark:bg-white/10"
        ...
        <div className="absolute bottom-0 left-1/2 mb-4 -translate-x-1/2 scale-0 opacity-0 transition-all duration-300 ease-out group-hover:-translate-y-10 group-hover:scale-100 group-hover:opacity-100">
          <div className="relative">
            <div className="whitespace-nowrap rounded-md bg-[#1DA1F2] px-4 py-2 text-sm font-[500] text-white">
              Twitter
            </div>
            <div className="absolute bottom-[-5px] left-1/2 -translate-x-1/2 border-l-[6px] border-r-[6px] border-t-[6px] border-l-transparent border-r-transparent border-t-[#1DA1F2]"></div>
          </div>
        </div>
      </div>
    </div>
