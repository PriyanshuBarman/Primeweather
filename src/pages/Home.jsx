...
const Home = () => {
  ...
  return (
    <div className="flex flex-col bg-[#ffffff] pb-14 dark:bg-[#1d1d1d] md:gap-2 md:overflow-y-hidden md:bg-[#fafafa] md:pb-5 md:dark:bg-[#1b1b1b]">
      <div className="relative flex flex-col items-center gap-4 text-black dark:text-white md:items-start md:justify-around md:gap-5 md:pl-20 md:pt-10 xl:flex-row">
        <Navbar />
        {!isDeskTop && <Sidebar />}

        <div className="mt-24 flex w-full flex-col items-center md:mt-9 md:space-y-9 xl:w-[37%]">
          <PreviewCard />
        ...
        <div className="hover-scale-2 flex h-full flex-col items-center bg-white dark:bg-transparent max-sm:min-w-full md:mt-6 md:flex md:flex-col md:items-center md:rounded-3xl md:pb-5 md:shadow-md xl:min-w-[29%] xl:max-w-[29%]">
